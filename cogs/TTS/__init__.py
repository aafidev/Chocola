...
class TTS(commands.Cog):
    ...
    @commands.command(
        name="tts",
        description="Converts text to speech and plays it in the voice channel.",
    )
    ...
    @commands.command(
        name="setlang", description="Sets the language and accent for text-to-speech."
    )
    ...
    @commands.command(
        name="langlist", description="Shows a list of supported languages and accents."
    )
    async def langlist(self, ctx):
        embed = nextcord.Embed(
            title="Language List",
            description="List of supported languages and accents.",
            color=nextcord.Color.green(),
        )
        embed.add_field(
            name="Languages", value="en, fr, zh-CN, zh-TW, pt, es", inline=False
        )
        embed.add_field(
            name="Accents",
